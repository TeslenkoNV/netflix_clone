...
const MovieCard: React.FC<MovieCardProps> = ({
    ...
    return (
        <div className='group bg-zinc-900 col-span relative h-[12vw]'>
            <img className='cursor-pointer object-cover transition duration shadow-xl rounded-md 
            ...
            src={data.thumbnailUrl}  alt="Thumbnail"/>
            <div className='z-10 bg-zinc-800 p-2 lg:p-4 absolute w-full transition shadow-md rounded-b-mb'>
